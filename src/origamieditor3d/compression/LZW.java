...
public class LZW {
    ...
    static public java.io.ByteArrayInputStream compressGIF(java.io.ByteArrayInputStream input) throws Exception {
...
/*
        ...
        */
        ...
        for (int i = 0; i < normalatlan.size(); i += 8) {
            ...
            for (int ii = 0; ii < normalt.length(); ii += 8) {
                fosb.add((byte)StringToBin(normalt.substring(ii, ii + 8)));
            }
        }
        fosb.add(0, (byte)fosb.size());
        fosb.add(0, (byte)(magn2-1));
        fosb.add((byte)1);
        fosb.add((byte)0x81);
